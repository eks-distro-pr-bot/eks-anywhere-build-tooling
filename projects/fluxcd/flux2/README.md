## **Flux**
![Version](https://img.shields.io/badge/version-v2.8.7-blue)
...
ex: [v2.1.2 compared to v2.8.7](https://github.com/fluxcd/flux2/compare/v2.1.2...v2.2.1). Check the `build` target for
